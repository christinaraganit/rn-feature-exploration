export const SOUNDS = [
    ...
    { id: 'lamb-sauce', label: 'WHERE\'S THE LAMB SAUCE?', soundEffect: require('../assets/sounds/lamb-sauce.mp3'), icon: require('../assets/icons/gordonramsey.png') },
    { id: 'eating', label: 'Eating', soundEffect: require('../assets/sounds/minecraft-eating.mp3'), icon: require('../assets/icons/minecraft-cake.png') },
    { id: 'blunder', label: 'Blunder', soundEffect: require('../assets/sounds/see-me-fall.mp3'), icon: require('../assets/icons/meow-blunder.png') },
];